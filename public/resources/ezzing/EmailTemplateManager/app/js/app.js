...
(function () {
    ...
    function URLConfig ($stateProvider, $locationProvider, $urlRouterProvider, helper) {
        ...
        $stateProvider
            .state('mailGenerator', {
                'url': '/mailGenerator',
		'templateUrl': 'resources/ezzing/EmailTemplateManager/app/views/components/mailGenerator/template.html',
		...
		'templateUrl': 'resources/ezzing/EmailTemplateManager/app/views/components/templateGenerator/template.html',
